...
public class CreateNetworkTask extends AbstractTask {
	...
	public void run(TaskMonitor monitor) {
		...
		final String[] histoneNames = {"H3K27me3", "H3K27ac", "H3K36me2", "H3K4me1", "H3K4me2", "H3K4me3", "H3K79me2", "H3K9ac", "H3K9me2", "H3K9me3", "H3S10ph", "H4K6ac", "H4K20me3"};
...
////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JLabel dialoglblHkac = new JLabel("H3K27ac");
		...
		btnRunWeon.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					writer.write("GENEs_file = "+System.getProperty("user.home")+"/WEoN_FlyT/example_data/dmel-all-filtered-r6.32_GENEs.gff\n");
