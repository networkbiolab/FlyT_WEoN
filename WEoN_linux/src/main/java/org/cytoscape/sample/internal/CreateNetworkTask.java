...
public class CreateNetworkTask extends AbstractTask {
	...
	public void run(TaskMonitor monitor) {
		...
		final String[] histoneNames = {"H3K27me3", "H3K36me3", "H3K36me2", "H3K4me1", "H3K4me2", "H3K4me3", "H3K79me2", "H3K9ac", "H3K9me2", "H3K9me3", "H3S10ph", "H4K6ac", "H4K20me3"};
		...
		btnRunWeon.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					writer.write("GENEs_file = "+System.getProperty("user.home")+"/WEoN_FlyT/example_data/dmel-all-filtered-r6.32-GENES.gff\n");
					//writer.write("TFBSs_file = "+System.getProperty("user.home")+"/WEoN/example_data/dmel-all-filtered-r6.12-TFBS.gff\n");
				...
				//doing a system call perl main.pl -r config -n red ref(1500) -o out
       			...
       			try {
					...
					if(f111.exists()) { 
       				...
       				System.out.println("perl "+System.getProperty("user.home")+"/WEoN_FlyT/main.pl -r "+System.getProperty("java.io.tmpdir")+"/config_"+ID+" -n "+System.getProperty("user.home")+"/WEoN_FlyT/"+netToUse+" -o \""+outputFolder+"\"");
					Process p = Runtime.getRuntime().exec("perl "+System.getProperty("user.home")+"/WEoN_FlyT/main.pl -r "+System.getProperty("java.io.tmpdir")+"/config_"+ID+" -n "+System.getProperty("user.home")+"/WEoN_FlyT/"+netToUse+" -o "+outputFolder);
					p.waitFor();
				...
				try {
					...
					BufferedReader br = new BufferedReader(new FileReader(System.getProperty("user.home")+"/WEoN_FlyT/gene2symbol.tsv"));
					try {
